...
// Pure-TypeScript SHA-256 so it runs identically on iOS, Android, and web
// without native crypto dependencies. Passwords are salted per-user before
// hashing so identical passwords never produce identical stored hashes.
